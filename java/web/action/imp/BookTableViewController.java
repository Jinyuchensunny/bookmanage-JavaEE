...
public class BookTableViewController extends ActionSupport implements ServletResponseAware, ServletRequestAware {
    ...
    public void findBookByBookClassId() throws IOException {
        String bookClassId = request.getParameter("bookClassId");
        List<Bookjyc> list = bookjycDao.findAllBookByBookClassId(new Integer(bookClassId));
        makeJson(list);
    }
